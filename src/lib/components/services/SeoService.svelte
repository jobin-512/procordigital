<script lang="ts">
  ...
  const stats = [
    ...
    { label: 'First-page keywords', value: '247+' },
    { label: 'ROI timeline', value: '90 days' }
  ];
</script>

<section id="seo" class="relative py-16 lg:py-24 noise-overlay grid-pattern" aria-labelledby="seo-heading">
  ...
  <div class="container-brutal relative z-10 grid gap-10 lg:grid-cols-[1fr_1fr] lg:items-center">
    <div use:reveal={{ x: -40 }}>
      ...
      <h2 id="seo-heading" class="mt-6 font-display text-5xl lg:text-7xl tracking-[-0.08em] leading-[0.9] max-w-xl animate-text-reveal">
        Organic traffic
        <br />
      ...
      <div class="mt-8 flex flex-wrap gap-3">
        {#each stats as stat, i}
          <div class="border-4 border-ink bg-white px-5 py-3 shadow-[4px_4px_0_#07111f]" use:reveal={{ y: 20, delay: 200 + i * 100 }}>
            <p class="font-display text-3xl tracking-[-0.08em] text-blueprint">{stat.value}</p>
    ...
    <div use:reveal={{ x: 40, delay: 150 }} class="brutal-card-insane bg-white p-6 sm:p-8">
      <div class="mb-5 flex items-center gap-3 border-4 border-ink bg-blueprint p-4">
        ...
        <span class="font-black uppercase text-sm text-white">SEO playbook</span>
      </div>
      ...
      <div class="mt-6 pt-5 border-t-4 border-ink">
        <a href="/services/seo" class="brutal-button-blue-insane w-full justify-center">
          Learn more
