...
<section id="contact" class="relative px-4 py-16 lg:py-28 noise-overlay grid-pattern" aria-labelledby="mobile-cta-heading">
  ...
  <div use:reveal={{ scale: 0.95 }} class="container-brutal brutal-card-insane relative overflow-hidden bg-hot p-8 sm:p-12 lg:p-16 text-center z-10">
    ...
    <h2 id="mobile-cta-heading" class="mx-auto mt-6 max-w-4xl font-display text-5xl leading-[0.9] tracking-[-0.08em] sm:text-7xl lg:text-8xl text-white animate-text-reveal">
      Let's build your
      <br />
