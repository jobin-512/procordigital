...
<section id="contact" class="relative px-4 py-16 lg:py-28 noise-overlay grid-pattern" aria-labelledby="process-cta-heading">
  ...
  <div use:reveal={{ scale: 0.95 }} class="container-brutal brutal-card-insane relative overflow-hidden bg-accent p-8 sm:p-12 lg:p-16 text-center z-10">
    ...
    <span class="section-label bg-white inline-block mb-6 animate-slide-up">Ready to start?</span>

    <h2 id="process-cta-heading" class="mx-auto mt-6 max-w-4xl font-display text-5xl leading-[0.9] tracking-[-0.08em] sm:text-7xl lg:text-8xl animate-text-reveal">
      Let's run the
      <br />
      <span class="gradient-text-hot">protocol on</span>
    ...
    <form class="mx-auto mt-8 grid max-w-3xl gap-3 sm:grid-cols-[1fr_auto] animate-slide-up" style="animation-delay: 350ms;" aria-label="Process inquiry">
